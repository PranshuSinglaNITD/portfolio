    ...
    <section id="about" className="py-24 px-6 relative z-10">
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          >
            <Card className="h-full bg-gradient-to-br from-muted/50 to-transparent border-border hover:border-foreground/20 transition-all shadow-lg">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-medium text-lg">{portfolioData.about.education.university}</h4>
                ...
                <div className="flex justify-between items-center text-sm border-t border-border pt-4">
                  ...
                  <span className="text-blue-400 font-mono bg-blue-400/10 px-2 py-1 rounded">CGPA: {portfolioData.about.education.cgpa}</span>
                </div>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="h-full bg-gradient-to-br from-muted/50 to-transparent border-border hover:border-foreground/20 transition-all shadow-lg flex flex-col">
                  ...
                  {portfolioData.about.interests.map((interest, i) => {
                    ...
                    return (
                      <motion.div 
                        ...
                        className="flex flex-col gap-2 p-4 rounded-xl bg-muted/50 border border-border hover:bg-muted hover:border-foreground/20 transition-all shadow-sm"
                      >
                        <div className="flex items-center gap-2">
                          <Icon size={18} className="text-purple-400" />
                          <span className="text-sm font-bold text-foreground">{interest.name}</span>
                        </div>
                        <span className="text-xs text-muted-foreground leading-relaxed">{interest.desc}</span>
                      </motion.div>
                    )
                  })}
                </div>
